...
(
    ...
    localparam PAD2 = log2ceil(64'h1060 - 64'h1040); 
    localparam PAD3 = log2ceil(64'h1068 - 64'h1060); 
    ...
    // ( 0x1040 .. 0x1060 )
    if ( {address[RG:PAD2],{PAD2{1'b0}}} == 19'h1040   ) begin
            src_channel = 6'b100000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 4;
    end

    // ( 0x1060 .. 0x1068 )
    if ( {address[RG:PAD3],{PAD3{1'b0}}} == 19'h1060   ) begin
